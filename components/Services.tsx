...
export default function Services() {
  return (
    <section className="py-12 sm:py-20 lg:py-28 bg-white" id="services">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        <a
          href="/services"
          className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-teal-500 text-white px-6 sm:px-8 py-4 rounded-2xl font-bold text-base hover:bg-teal-600 transition-colors shadow-md hover:shadow-lg"
        >
          <Stethoscope size={20} />
          診療科目一覧を見る
          <ArrowRight size={18} />
